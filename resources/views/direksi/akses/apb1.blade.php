...
@section('title', 'WPS - Akses Pengguna Baru')
    ...
    <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="{{ url('/direksi/akses/penggunabaru') }}">Pengguna Baru</a>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Akses Pengguna Baru</h1>
    </div>
                                ...
                                @foreach($pengguna as $pengguna)
                                    @if($pengguna->validasi == 'INVALID')
                                        <tr>
                                            ...
                                            <td>
                                                <form action="/direksi/akses/penggunabaru/{{ $pengguna->id }}" method="post" class="d-inline">
                                                    @method('patch')
                                                    @csrf
                                                    <button type="submit" class="badge badge-success" id="btn-validasi">
                                                        Validasi
                                                    </button>
                                                </form>
                                                <form action="/direksi/akses/penggunabaru/{{ $pengguna->id }}" method="post" class="d-inline btn-hapus">
                                                    @method('delete')
                                                    @csrf
