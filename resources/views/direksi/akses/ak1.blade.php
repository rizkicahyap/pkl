...
@section('title', 'WPS - Akses Kategori')
    ...
    <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="{{ url('/direksi/akses/kategori') }}">Kategori</a>
            </div>
        </div>
    </li>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Akses Kategori</h1>
    </div>
                        ...
                        <table class="table table-bordered" id="ssfp">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" style="width: 62%">Nama Kategori</th>
                                ...
                                @foreach($kategori as $kategori)
                                    @if($kategori->akses == 'BELUM' && $kategori->req_akses == 'UBAH' || $kategori->akses == 'BELUM' && $kategori->req_akses == 'HAPUS')
                                        <tr>
                                            ...
                                            <td>
                                            @if($kategori->akses == 'BELUM' && $kategori->req_akses == 'UBAH')
                                                Pengubahan Kategori
                                            ...
                                            <td>
                                            <form action="/direksi/akses/kategori/{{ $kategori->id }}" method="post" class="d-inline" >
                                                    @method('put')
                                                    @csrf
