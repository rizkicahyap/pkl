...
<!-- Page Heading -->
<a href="{{ url('/user/datasurat') }}" class="btn btn-outline-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
...
<div class="container">
    <div class="row">
        <div class="col-8">
            <form method="post" action="{{ url('/user/datasurat') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <label for="tgl_diterima" class="form-label">Tanggal Diterima / Tanggal Dikirim</label>
                        <input type="date" class="form-control @error('tgl_diterima') is-invalid @enderror" id="tgl_surat" name="tgl_diterima" value="{{ old('tgl_diterima') }}">
                        <!-- @error('tgl_diterima')
                ...
                <div class="form-group">
                    <label for="file" class="form-label">File (gambar atau .pdf)</label>
                        <input type="file" class="form-control-file @error('filename') is-invalid @enderror" id="filename" placeholder="Masukkan File" name="filename" value="{{ old('filename') }}"accept="image/*,application/pdf">
                        @error('filename')
