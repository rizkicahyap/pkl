...
<div class="container-fluid">
    ...
    <div class="row justify-content-between">
        <div class="col-3">
            <!-- <a href="/user/formatsurat/buatformat" class="btn btn-primary my-4"><i class="fas fa-plus text-gray-100"></i>   Tambah</a> -->
    ...
    <!-- <div class="row"> -->
                                ...
                                <tbody>
                                    ...
                                    @foreach($format_surat as $fs)
                                        <tr>
                                            ...
                                            <td>
                                            <a href="/user/formatsurat/{{ $fs->id }}" class="badge badge-primary">Lihat Format</a>
                                            </td>
                                        </tr>
                                        @php
                                            $nomor += 1;
        ...
        <!-- @foreach($format_surat as $fs)
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-dark kotak-format shadow">
                    ...
                    <div class="card-footer">
                        <a href="/user/formatsurat/{{ $fs->id }}" class="btn btn-primary float-right my-2 mr-2">Get Format</a>
                    </div>
                </div>
            </div>
        @endforeach  -->
