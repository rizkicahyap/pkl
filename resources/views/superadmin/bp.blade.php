...
@section('title', 'WPS - Tambah Pengguna')
...
<div class="d-sm-flex align-items-center justify-content-between my-2">
    <h1 class="h3 text-gray-800">Form Tambah Pengguna</h1>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-8">
            <form method="post" action="{{ url('/superadmin/datapengguna') }}" enctype="multipart/form-data">
                @csrf
                ...
                <button type="submit" class="btn btn-primary my-4">Tambah Pengguna</button>
