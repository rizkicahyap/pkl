...
<div class="d-sm-flex align-items-center justify-content-between my-2">
    <h1 class="h3 text-gray-800">Form Ubah Kategori</h1>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-8">
            <form method="post" action="/admin/kategori/{{ $adminKtgr->id }}">
                @method('patch')
                @csrf        
                <div class="form-group">
                    <label for="nama_ktgr" class="form-label">Nama Kategori</label>
                        <input type="text" class="form-control @error('nama_ktgr') is-invalid @enderror" id="nama_ktgr" placeholder="Masukkan Nama Kategori" name="nama_ktgr" value="{{ $adminKtgr->nama_ktgr }}">
                        @error('nama_ktgr')
